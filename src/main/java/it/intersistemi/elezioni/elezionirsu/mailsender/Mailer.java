...
//         sendMail(emailProperties, emailMessage, MessageComposer.STANDARD, () -> new UserAuthenticator(emailProperties.getMailPass()));
//     }
//
...
//
//             //Logger errors
//             logger.error("Email address that generate exception {}");
//
...
//        InternetAddress internetAddressFrom = new InternetAddress(userAuth.getUsername());
//
//        // Create email object
...
//        }
//
//        message.setSubject(getSubject(emailMessage.getSubject(), emailProperties.getMailSuffix());
//
//        // Body of the message with test has been created
...
//
//
//        // AAdd the multipart to the message
